...
public class InitProvider extends ContentProvider
{
     ...
     */
    @VisibleForTesting
    static final String EMPTY_APPLICATION_ID_PROVIDER_AUTHORITY = "com.zeoflow.depot.dispatcher";
    ...
    public boolean onCreate()
    {
        ...
        if (PreferenceApp.initializeApp(getContext()) == null)
        {
            throw new IllegalStateException("PreferenceApp initialization unsuccessful");
        }
        return false;
    }
