...
/**
 * The list of warnings that are produced by Depot.
 * <p>
 * You can use these values inside a {@link SuppressWarnings} annotation to disable the warnings.
 */
// If you change this, don't forget to change com.zeoflow.depot.vo.Warning
@SuppressWarnings({"unused", "WeakerAccess"})
public class DepotWarnings {
    /**
     * The warning dispatched by Depot when the return value of a {@link Query} method does not
     * exactly match the fields in the query result.
     */
    public static final String CURSOR_MISMATCH = "DEPOT_CURSOR_MISMATCH";

    /**
     * Reported when Depot cannot verify database queries during compilation due to lack of
     * tmp dir access in JVM.
     */
    public static final String MISSING_JAVA_TMP_DIR = "DEPOT_MISSING_JAVA_TMP_DIR";

    /**
     * Reported when Depot cannot verify database queries during compilation. This usually happens
     * when it cannot find the SQLite JDBC driver on the host machine.
     * <p>
     * Depot can function without query verification but its functionality will be limited.
     */
    public static final String CANNOT_CREATE_VERIFICATION_DATABASE =
            "DEPOT_CANNOT_CREATE_VERIFICATION_DATABASE";
    ...
    public static final String PRIMARY_KEY_FROM_EMBEDDED_IS_DROPPED =
            "DEPOT_EMBEDDED_PRIMARY_KEY_IS_DROPPED";
    ...
    public static final String INDEX_FROM_EMBEDDED_FIELD_IS_DROPPED =
            "DEPOT_EMBEDDED_INDEX_IS_DROPPED";
    ...
    public static final String INDEX_FROM_EMBEDDED_ENTITY_IS_DROPPED =
            "DEPOT_EMBEDDED_ENTITY_INDEX_IS_DROPPED";

    /**
     * Reported when an {@link Entity}'s parent declares an {@link Index}. Depot does not
    ...
    public static final String INDEX_FROM_PARENT_FIELD_IS_DROPPED =
            "DEPOT_PARENT_FIELD_INDEX_IS_DROPPED";

    /**
     * Reported when a {@link Relation} {@link Entity}'s SQLite column type does not match the type
     * in the parent. Depot will still do the matching using {@code String} representations.
     */
    public static final String RELATION_TYPE_MISMATCH = "DEPOT_RELATION_TYPE_MISMATCH";

    /**
     * Reported when a `depot.schemaLocation` argument is not provided into the annotation processor.
     * You can either set {@link Database#exportSchema()} to {@code false} or provide
     * `depot.schemaLocation` to the annotation processor. You are strongly adviced to provide it
     * and also commit them into your version control system.
     */
    public static final String MISSING_SCHEMA_LOCATION = "DEPOT_MISSING_SCHEMA_LOCATION";
     ...
     * scan on Entity B.
     * <p>
     * If Depot cannot find a proper index in the child entity (Entity B in this case), Depot will
     * print this warning.
     */
    public static final String MISSING_INDEX_ON_FOREIGN_KEY_CHILD =
            "DEPOT_MISSING_FOREIGN_KEY_CHILD_INDEX";
     ...
     * <p>
     * It is recommended that columns on entities used as junctions contain indices, otherwise Depot
     * will print this warning.
     */
    public static final String MISSING_INDEX_ON_JUNCTION = "MISSING_INDEX_ON_JUNCTION";

    /**
     * Reported when a POJO has multiple constructors, one of which is a no-arg constructor. Depot
     * will pick that one by default but will print this warning in case the constructor choice is
     * important. You can always guide Depot to use the right constructor using the @Ignore
     * annotation.
     */
    public static final String DEFAULT_CONSTRUCTOR = "DEPOT_DEFAULT_CONSTRUCTOR";
    ...
    public static final String RELATION_QUERY_WITHOUT_TRANSACTION =
            "DEPOT_RELATION_QUERY_WITHOUT_TRANSACTION";
     ...
     * {@code false} when {@code Foo.value} is {@code null} since Depot will use the {@code getValue}
     ...
     */
    public static final String MISMATCHED_GETTER = "DEPOT_MISMATCHED_GETTER_TYPE";
     ...
     * </pre>
     *
     * If Depot reads this entity from the database, it will always set {@code Foo.value} to
     * {@code false} when the column value is {@code null} since Depot will use the {@code setValue}
     * method to write the value.
     */
    public static final String MISMATCHED_SETTER = "DEPOT_MISMATCHED_SETTER_TYPE";

    /** @deprecated This type should not be instantiated as it contains only static methods. */
    @Deprecated
    @SuppressWarnings("PrivateConstructorForUtilityClass")
    public DepotWarnings() {
    }
}
