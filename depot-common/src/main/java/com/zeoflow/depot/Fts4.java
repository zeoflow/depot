...
import static com.zeoflow.depot.FtsOptions.TOKENIZER_SIMPLE;
...
public @interface Fts4 {
     ...
     * <p>
     * In "external mode" the content table and the FTS table need to be synced. Depot will create
     ...
     * <p>
     * The content sync triggers created by Depot will be removed before migrations are executed and
