 ...
 * query as a {@link com.zeoflow.sqlite.db.SupportSQLiteQuery SupportSQLiteQuery}.
 * <pre>
 * {@literal @}Dao
 * interface RawDao {
 *   {@literal @}RawQuery
 ...
 * </pre>
 * <p>
 * Depot will generate the code based on the return type of the function and failure to
 ...
 * the query at compile time and also generates more efficient code since Depot can compute the
 ...
 * SQL query at runtime but still use Depot to convert it into objects.
 * <p>
 * {@code RawQuery} methods must return a non-void type. If you want to execute a raw query that
 * does not return any value, use {@link com.zeoflow.depot.DepotDatabase#query
 * DepotDatabase#query} methods.
 * <p>
 * RawQuery methods can only be used for read queries. For write queries, use
 * {@link com.zeoflow.depot.DepotDatabase#getOpenHelper
 * DepotDatabase.getOpenHelper().getWritableDatabase()}.
 * <p>
