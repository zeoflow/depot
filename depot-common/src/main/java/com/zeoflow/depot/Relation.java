 ...
 * When the POJO is returned from a query, all of its relations are also fetched by Depot.
 *
 * <pre>
 * {@literal @}Entity
 * public class Song {
 ...
 * <href="https://developer.android.com/training/data-storage/depot/referencing-data#understand-no-object-references">
 * Depot documentation</>. When loading data, you can simply work around this limitation by creating
