...
/**
 * Marks a class as a DepotDatabase.
 * <p>
 * The class should be an abstract class and extend {@link com.zeoflow.depot.DepotDatabase DepotDatabase}.
 * <p>
 * You can receive an implementation of the class via
 * {@link com.zeoflow.depot.Depot#databaseBuilder Depot.databaseBuilder} or
 * {@link com.zeoflow.depot.Depot#inMemoryDatabaseBuilder Depot.inMemoryDatabaseBuilder}.
 * <p>
 * <pre>
 * // Song and Album are classes annotated with {@literal @}Entity.
 * {@literal @}Database(version = 1, entities = {Song.class, Album.class})
 * abstract class MusicDatabase extends DepotDatabase {
 ...
 * access.
 * <p>
 * Depot also verifies all of your queries in {@link Dao} classes while the application is being
...
public @interface Database {
    ...
    /**
     * You can set the annotation processor argument ({@code com.zeoflow.depot.schemaLocation}) to tell Depot to
     ...
     * {@link com.zeoflow.depot.migration.Migration Migration} added with
     * {@link com.zeoflow.depot.DepotDatabase.Builder#addMigrations addMigrations} can still be used.
     *
