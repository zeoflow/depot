 ...
 * <p>
 * You should use this as the last resort if Depot cannot properly understand your query and you are
 * 100% sure it works. Removing validation may limit the functionality of Depot since it won't be
