...
public @interface ColumnInfo {
     ...
     * <p>
     * If it is not specified, the value defaults to {@link #UNDEFINED} and Depot resolves it based
     ...
     * <p>
     * The default value is {@link #UNSPECIFIED}. In that case, Depot does not add any
    ...
    /**
     * Constant to let Depot inherit the field name as the column name. If used, Depot will use the
