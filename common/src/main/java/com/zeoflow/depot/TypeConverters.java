...
/**
 * Specifies additional type converters that Depot can use. The TypeConverter is added to the scope
...
public @interface TypeConverters {
    /**
     * The list of type converter classes. If converter methods are not static, Depot will create
