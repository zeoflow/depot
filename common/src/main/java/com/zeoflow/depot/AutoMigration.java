 ...
 * <p>
 * An automatic migration is a {@link com.zeoflow.depot.migration.Migration Migration} that is generated
 * via the use of database schema files at two versions of a {@link com.zeoflow.depot.DepotDatabase
 * DepotDatabase}. Depot automatically detects changes on the database between these two schemas,
 * and constructs a {@link com.zeoflow.depot.migration.Migration Migration} to migrate between the
 ...
 * {@link com.zeoflow.depot.migration.AutoMigrationSpec AutoMigrationSpec} property.
 * <p>
 ...
 * the {@link com.zeoflow.depot.migration.AutoMigrationSpec AutoMigrationSpec} property to either
 ...
 * such scenarios then an {@link com.zeoflow.depot.migration.AutoMigrationSpec AutoMigrationSpec} is
 ...
 * no ambiguous scenario is present, then the {@link com.zeoflow.depot.migration.AutoMigrationSpec
 * AutoMigrationSpec} property is optional.
 * <p>
 * If an auto migration is defined for a database, then {@link Database#exportSchema}
 * must be set to true.
 * <p>
 * Example:
 * <pre>
 ...
 * </pre>
 *
 * @see com.zeoflow.depot.DepotDatabase DepotDatabase
 * @see com.zeoflow.depot.migration.AutoMigrationSpec AutoMigrationSpec
 */
