...
/**
 * Handles all the communication from {@link DepotDatabase} and {@link InvalidationTracker} to
    ...
    final Runnable mSetUpRunnable = new Runnable() {
        ...
        public void run() {
            try {
                ...
                Log.w(Depot.LOG_TAG, "Cannot register multi-instance invalidation callback", e);
            }
        }
    };
        ...
        mObserver = new InvalidationTracker.Observer(tableNames.toArray(new String[0])) {
            ...
            public void onInvalidated(@NonNull Set<String> tables) {
                ...
                try {
                    ...
                    Log.w(Depot.LOG_TAG, "Cannot broadcast invalidation", e);
                }
            }
    ...
    void stop() {
        if (mStopped.compareAndSet(false, true)) {
            ...
            try {
                ...
                Log.w(Depot.LOG_TAG, "Cannot unregister multi-instance invalidation callback", e);
            }
