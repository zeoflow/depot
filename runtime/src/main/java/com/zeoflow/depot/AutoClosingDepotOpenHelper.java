 ...
 */
final class AutoClosingDepotOpenHelper implements SupportSQLiteOpenHelper, DelegatingOpenHelper {
    @NonNull
    ...
    AutoClosingDepotOpenHelper(@NonNull SupportSQLiteOpenHelper supportSQLiteOpenHelper,
