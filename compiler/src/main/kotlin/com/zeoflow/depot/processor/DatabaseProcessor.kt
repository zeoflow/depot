...
class DatabaseProcessor(baseContext: Context, val element: XTypeElement) {
    ...
    ): List<com.zeoflow.depot.vo.AutoMigration> {
        val dbAnnotation = element.getAnnotation(com.zeoflow.depot.Database::class)!!

        val autoMigrationList = dbAnnotation
            .getAsAnnotationBoxArray<com.zeoflow.depot.AutoMigration>("autoMigrations")
    ...
    private fun processEntities(
        dbAnnotation: XAnnotationBox<com.zeoflow.depot.Database>,
        element: XTypeElement
    ): List<Entity> {
