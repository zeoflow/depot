...
import com.zeoflow.depot.parser.expansion.ProjectionExpander
import com.zeoflow.depot.parser.optimization.RemoveUnusedColumnQueryRewriter
import com.zeoflow.depot.preconditions.Checks
...
import com.zeoflow.depot.solver.TypeAdapterStore
...
class Context private constructor(
    ...
    private fun XElement.hasRemoveUnusedColumnsAnnotation(): Boolean {
        return hasAnnotation(com.zeoflow.depot.RewriteQueriesToDropUnusedColumns::class).also { annotated ->
    ...
    enum class ProcessorOptions(val argName: String) {
        OPTION_SCHEMA_FOLDER("com.zeoflow.depot.schemaLocation")
    }

    enum class BooleanProcessorOptions(val argName: String, private val defaultValue: Boolean) {
        INCREMENTAL("com.zeoflow.depot.incremental", true),
        EXPAND_PROJECTION("com.zeoflow.depot.expandProjection", false);
