...
class FtsEntity(
    ...
    private fun createTriggerName(tableName: String, triggerOp: String) =
        "depot_fts_content_sync_${tableName}_$triggerOp"

    override fun toBundle() = com.zeoflow.depot.migration.bundle.FtsEntityBundle(
        tableName,
        createTableQuery(com.zeoflow.depot.migration.bundle.BundleUtil.TABLE_NAME_PLACEHOLDER),
