...
import com.zeoflow.depot.util.SchemaDiffResult
...
data class AutoMigration(
     ...
     */
    data class AddedColumn(val tableName: String, val fieldBundle: com.zeoflow.depot.migration.bundle.FieldBundle)
     ...
     */
    data class AddedTable(val entityBundle: com.zeoflow.depot.migration.bundle.EntityBundle)
    ...
    data class ComplexChangedTable(
        ...
        val oldVersionEntityBundle: com.zeoflow.depot.migration.bundle.EntityBundle,
        val newVersionEntityBundle: com.zeoflow.depot.migration.bundle.EntityBundle,
