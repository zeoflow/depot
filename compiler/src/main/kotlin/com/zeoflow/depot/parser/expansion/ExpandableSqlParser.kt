...
import com.zeoflow.depot.parser.SingleQuerySqlParser
import com.zeoflow.depot.parser.Table
...
class ExpandableQueryVisitor(
...
) : com.zeoflow.depot.parser.SQLiteBaseVisitor<Void?>() {
    ...
    private fun findQueryType(statement: ParseTree): QueryType {
        return when (statement) {
            is com.zeoflow.depot.parser.SQLiteParser.Select_stmtContext ->
                QueryType.SELECT
            is com.zeoflow.depot.parser.SQLiteParser.Delete_stmt_limitedContext,
            is com.zeoflow.depot.parser.SQLiteParser.Delete_stmtContext ->
                QueryType.DELETE
            is com.zeoflow.depot.parser.SQLiteParser.Insert_stmtContext ->
                QueryType.INSERT
            is com.zeoflow.depot.parser.SQLiteParser.Update_stmtContext,
            is com.zeoflow.depot.parser.SQLiteParser.Update_stmt_limitedContext ->
                QueryType.UPDATE
    ...
    override fun visitResult_column(ctx: com.zeoflow.depot.parser.SQLiteParser.Result_columnContext?): Void? {
        fun addProjectionSection(
            c: com.zeoflow.depot.parser.SQLiteParser.Result_columnContext,
    ...
    override fun visitExpr(ctx: com.zeoflow.depot.parser.SQLiteParser.ExprContext): Void? {
...
private val RuleContext.isCoreSelect: Boolean
    get() {
        return this is com.zeoflow.depot.parser.SQLiteParser.Select_or_valuesContext &&
            ancestors().none { it is com.zeoflow.depot.parser.SQLiteParser.Select_or_valuesContext }
    }
