...
data class SchemaDiffResult(
    ...
    val fromViews: List<com.zeoflow.depot.migration.bundle.DatabaseViewBundle>,
    val toViews: List<com.zeoflow.depot.migration.bundle.DatabaseViewBundle>
)
...
class SchemaDiffer(
    ...
    // for easy lookup.
    private val contentTableToFtsEntities = mutableMapOf<String, MutableList<com.zeoflow.depot.migration.bundle.EntityBundle>>()
    ...
    private fun isForeignKeyBundlesListEqual(
        fromBundle: List<com.zeoflow.depot.migration.bundle.ForeignKeyBundle>,
        toBundle: List<com.zeoflow.depot.migration.bundle.ForeignKeyBundle>
    ): Boolean {
    ...
    private fun isIndexBundlesListEqual(
        fromBundle: List<com.zeoflow.depot.migration.bundle.IndexBundle>,
        toBundle: List<com.zeoflow.depot.migration.bundle.IndexBundle>
    ): Boolean {
        val set = fromBundle + toBundle
